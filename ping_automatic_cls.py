...
def get_week_start_sunday(d: datetime.date) -> datetime.date:
    """Returns the Sunday of the calendar week containing `d`."""
...
def main(argv: list[str]) -> None:
    ...
    # NOTE(b/542171700): Please keep this subject constant per week, so Chat
    # threads these notifications instead of posting new discussions every run.
    week_start = get_week_start_sunday(datetime.date.today())
    subject = f"Autogenerated CL(s) need review (week of {week_start})"
    body = (
